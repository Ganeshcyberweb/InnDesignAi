  ...
  return (
    ...
    >
      <motion.div
        ...
        ref={rootRef}
        className={cx(
          "bg-background relative bottom-8 z-3 flex flex-col items-center overflow-hidden border border-stone-200 max-sm:bottom-5"
        )}
        initial={false}
        animate={{
...
function Kbd({
  ...
  return (
    <kbd
      className={cx(
        "bg-primary text-foreground flex h-6 w-fit items-center justify-center rounded-sm px-[6px] font-sans",
        className
      )}
    >
      {children}
